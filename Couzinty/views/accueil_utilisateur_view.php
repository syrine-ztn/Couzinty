...
class accueil_utilisateur_view
{
        ...
        <div id="container-slider" class = "container-responsive">
         <div id = "carouselwithIndicators" class = "carousel slide" data-ride = "carousel">    
            <div class ="carousel-inner h-50">
               ...
               <?php 
                 $cpt=0;
                 $controller = new accueil_utilisateur_controller(); 
    ...
    ?>
     ...
     ?> 
       ...
       <br/><br/><br/><br/><br/>
       <div class="container mt-0" style="border: solid; padding-bottom: 50%; padding-top: 2%;">
    ...
    public function afficher_accueil_utilisateur()
    {
        $this->entete();
        $this->diaporama();
        $this->menu();
