...
class fete_view
{
   ...
   <table class="table-borderless" id="table" data-toggle="table" data-filter-control="true" data-escape="false" data-click-to-select="true" class="table">
	<thead style="float:left;">
		<tr>
         ...
         <th data-visible="false" data-field="saison" data-filter-control="input" data-sortable="true">Saison</th>
   ...
   <?php      
                $cpt=0;
                $controller = new fete_controller();
                $resultat = $controller->getFete();
              ...
              <?php echo $row["image"] ?>
    			...
    			<div class="col-md-8">
    				<div class="card-block">
    					<h4 class="card-title"><?php echo $row["nom_recette"] ?></h4><br/>
                  ...
                  <p><b>Fête : </b><?php echo $row["fete"] ?></p>
